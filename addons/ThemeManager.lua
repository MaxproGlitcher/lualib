...
local ThemeManager = {} do
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddDropdown('ThemeManager_CustomThemeList', { Text = 'Personal themes', Values = self:ReloadCustomThemes(), AllowNull = true, Default = 1 })
